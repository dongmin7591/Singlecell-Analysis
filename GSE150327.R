...
e12smg.data <- Read10X(data.dir = "GSE150327/mtx/E12_filtered_feature_bc_matrix/")
e14smg.data <- Read10X(data.dir = "GSE150327/mtx/E14_filtered_feature_bc_matrix/")
e16smg.data <- Read10X(data.dir = "GSE150327/mtx/E16_filtered_feature_bc_matrix/")
p1smg.data <- Read10X(data.dir = "GSE150327/mtx/P1_filtered_feature_bc_matrix/")
p30.male.data <- Read10X_h5(filename =  "GSE150327/h5/GSM4546897_P30_M_filtered_gene_bc_matrices_h5.h5")
p30.female.data <- Read10X_h5(filename = "GSE150327/h5/GSM4546896_P30_F_filtered_gene_bc_matrices_h5.h5")
adult.data <-  Read10X(data.dir = "GSE150327/mtx/Adult_filtered_feature_bc_matrix/")
#1. cluster and Intergration
...
e12smg[["stage"]] <- "E12"
e12smg <- RenameIdents(e12smg, '0' = "Mesenchyme",'1' = "Mesenchyme",'2' = "Mesenchyme",'3' = "Mesenchyme",'4' = "Mesenchyme",'5' = "Mesenchyme",'6'="End bud",'7' = "Krt19+ duct", 
...
e14markers.top5 <- e14markers %>% group_by(cluster) %>% top_n(5,avg_log2FC)
...
e14.cell.markers.top5 <- e14.cell.markers %>% group_by(cluster) %>% top_n(5,avg_log2FC)
...
e16markers.top5 <- e16markers %>% group_by(cluster) %>% top_n(5,avg_log2FC)
...
e16.cell.markers.top5 <- e16.cell.markers %>% group_by(cluster) %>% top_n(5,avg_log2FC)
...
p1markers.top5 <- p1markers %>% group_by(cluster) %>% top_n(5,avg_log2FC)
...
p1.cell.markers.top5 <- p1.cell.markers %>% group_by(cluster) %>% top_n(5,avg_log2FC)
